...
SRC_URI="
	amd64?	( https://download-cdn.resilio.com/stable/linux-x64/resilio-sync_x64.tar.gz -> ${NAME}_x64-stable.tar.gz )
	x86?	( https://download-cdn.resilio.com/stable/linux-i386/resilio-sync_i386.tar.gz -> ${NAME}_i386-stable.tar.gz )
	arm?	( https://download-cdn.resilio.com/stable/linux-arm/resilio-sync_arm.tar.gz -> ${NAME}_arm-stable.tar.gz )"
